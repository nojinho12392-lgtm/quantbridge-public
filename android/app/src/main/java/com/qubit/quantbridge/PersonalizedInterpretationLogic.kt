...
internal fun personalizedStockInterpretation(
    profile: InvestmentProfile,
    name: String,
    highScore: Boolean,
    growthGood: Boolean,
...
internal fun coverageCurationInsight(
    name: String,
    hasQuality: Boolean,
...
internal fun String.hasCoverageValue(): Boolean {
    val clean = trim()
    return clean.isNotBlank() && clean != "-" && clean != "N/A"
}

internal fun String.coverageMatches(vararg tokens: String): Boolean {
